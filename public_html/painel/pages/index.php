...
<div class="pa-wrap">
  ...
  <style>
    ...
    .b-success { background: #e9fbfc; color: #138a91; }
    .b-error   { background: #fff1f2; color: #be3a45; }
    .b-process { background: #e9fbfc; color: #138a91; }
    .b-paid    { background: #e9fbfc; color: #138a91; }
    .b-pending { background: #fff8e8; color: #b7791f; }
