...
<div class="pa-wrap">
  ...
  <style>
    ...
    .b-success { background: #dcfce7; color: #00a651; }
    .b-error   { background: #fee2e2; color: #e60023; }
    .b-process { background: #dbeafe; color: #0057ff; }
    .b-paid    { background: #ccfbf1; color: #00a8c6; }
    .b-pending { background: #fef3c7; color: #ff8c00; }
